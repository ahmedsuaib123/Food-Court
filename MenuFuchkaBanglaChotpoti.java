...
public class MenuFuchkaBanglaChotpoti extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFuchkaBanglaChotpoti(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
	...
	public static void main(String []args){
        ...
        new MenuFuchkaBanglaChotpoti(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
