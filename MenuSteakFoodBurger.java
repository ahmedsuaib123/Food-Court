...
public class MenuSteakFoodBurger extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSteakFoodBurger(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
        ...
        JLabel item2Name = new JLabel("Chicken Cheese Burger");
        ...
        JLabel item3Name = new JLabel("Crispy Chicken Burger");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Cheese Burger   "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Crispy Chicken Burger    "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
