...
public class MenuLazizSalad extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuLazizSalad(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Chicken Cashewnut Salad");
        ...
        JLabel item2Name = new JLabel("Chicken Corn Soup");
        ...
        JLabel item3Name = new JLabel("Thai Soup");
	...
	public static void main(String []args){
        ...
        new MenuLazizSalad(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Cashewnut Salad         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Corn Soup          "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Thai Soup       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
