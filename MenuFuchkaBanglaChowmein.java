...
public class MenuFuchkaBanglaChowmein extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFuchkaBanglaChowmein(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
        ...
        JLabel item2Name = new JLabel("Mixed Chowmein");
        ...
        JLabel item3Name = new JLabel("Special Chowmein");
        ...
        JLabel item4Name = new JLabel("Chicken Sizzling Chowmein");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Mixed Chowmein     "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Special Chowmein    "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Sizzling Chowmein    "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
