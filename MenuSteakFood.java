...
public class MenuSteakFood extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSteakFood(/*HomePageDhali homePageDhali*/) 
	{
		frame=new JFrame();
		...
		item1Image.setBounds(20, 30, 100, 100);
		

		JLabel item1Name = new JLabel("Oven Baked Chicken Pasta");
		item1Name.setBounds(20, 30, 300, 25);

		JLabel item1Price = new JLabel("Price: "+object.x+" TK");
		item1Price.setBounds(20, 60, 100, 25);
		

		JLabel item1QuantityLabel = new JLabel("Quantity:");
		item1QuantityLabel.setBounds(20, 90, 100, 25);
		

		item1Quantity = new JTextField();
		item1Quantity.setBounds(80, 90, 30, 25);
        ...
        JLabel item2Name = new JLabel("Rice Bowl with Mexican Chicken & Egg Omelette");
        item2Name.setBounds(250, 30, 300, 25);
        

        JLabel item2Price = new JLabel("Price: "+object.y+" TK");
        item2Price.setBounds(250, 60, 100, 25);
        
		
		JLabel item2QuantityLabel = new JLabel("Quantity:");
        item2QuantityLabel.setBounds(250, 90, 100, 25);
        

        item2Quantity = new JTextField();
        item2Quantity.setBounds(310, 90, 30, 25);
        ...
        item3Name.setBounds(20, 140, 100, 25);
   

        JLabel item3Price = new JLabel("Price: "+object.z+" TK");
        item3Price.setBounds(20, 160, 100, 25);
 
		
		JLabel item3QuantityLabel = new JLabel("Quantity:");
        item3QuantityLabel.setBounds(20, 190, 100, 25);
   

        item3Quantity = new JTextField();
        item3Quantity.setBounds(80, 190, 30, 25); 
  

	    // Item 4: Coffee
        JLabel item4Image = new JLabel(new ImageIcon("images/Coffee2.png"));
        item4Image.setBounds(250, 30, 100, 100);
   



        JLabel item4Name = new JLabel("Crispy Fried Chicken");
        item4Name.setBounds(250, 140, 300, 25);
    

        JLabel item4Price = new JLabel("Price: "+object.s+" TK");
        item4Price.setBounds(250, 165, 100, 25);
  												
		
		JLabel item4QuantityLabel = new JLabel("Quantity:");
        item4QuantityLabel.setBounds(250, 190, 100, 25);
   

        item4Quantity = new JTextField();
        item4Quantity.setBounds(310, 190, 30, 25);
        ...
        JLabel item5Name = new JLabel("Steak Cheese Pasta");
        item5Name.setBounds(250, 360, 300, 25);
  

        JLabel item5Price = new JLabel("Price: "+object.a+" TK");
        item5Price.setBounds(250, 385, 100, 25);
      
		
		JLabel item5QuantityLabel = new JLabel("Quantity:");
        item5QuantityLabel.setBounds(250, 410, 100, 25);
      

        item5Quantity = new JTextField();
        item5Quantity.setBounds(310, 410, 30, 25); 
 


		// Item 6: Sandwich
        JLabel item6Image = new JLabel(new ImageIcon("images/Sandwitch2.jpg"));
        item6Image.setBounds(250, 150, 100, 100);


        JLabel item6Name = new JLabel("Fried Rice with Crispy Chicken & Masala Curry");
        item6Name.setBounds(250, 250, 300, 25);
    

        JLabel item6Price = new JLabel("Price: "+object.b+" TK");
        item6Price.setBounds(250, 275, 100, 25);
    
		
		JLabel item6QuantityLabel = new JLabel("Quantity");
        item6QuantityLabel.setBounds(250, 300, 100, 25);
   

        item6Quantity = new JTextField();
        item6Quantity.setBounds(310, 300, 30, 25);
        ...
        JLabel item7Name = new JLabel("Chicken Mixed Nachos");
        item7Name.setBounds(20, 360, 200, 25);
     

        JLabel item7Price = new JLabel("Price: "+object.c+" TK");
        item7Price.setBounds(20, 385, 100, 25);
 
		
		JLabel item7QuantityLabel = new JLabel("Quantity:");
        item7QuantityLabel.setBounds(20, 410, 100, 25);
    

        item7Quantity = new JTextField();
        item7Quantity.setBounds(80, 410, 30, 25);
        ...
        JLabel item8Name = new JLabel("Crispy Fried Wings");
        item8Name.setBounds(20, 250, 100, 25);
    

        JLabel item8Price = new JLabel("Price: "+object.d+" TK");
        item8Price.setBounds(20, 275, 100, 25);
 
		
		JLabel item8QuantityLabel = new JLabel("Quantity:");
        item8QuantityLabel.setBounds(20, 300, 100, 25);
   

        item8Quantity = new JTextField();
        item8Quantity.setBounds(80, 300, 30, 25);
    
		

        // JTextArea for the bill
        bill = new JTextArea();
        bill.setBounds(700,30,550,600);
	...
	{
		MenuSteakFood msf = new MenuSteakFood();
	}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Oven Baked Chicken Pasta "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Rice Bowl with Mexican Chicken & Egg Omelette          "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Crispy Fried Chicken  "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Steak Cheese Pasta "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fried Rice with Crispy Chicken & Chicken Masala Curry  "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Mixed Nachos          "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Crispy Fried Wings          "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
