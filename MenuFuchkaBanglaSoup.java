...
public class MenuFuchkaBanglaSoup extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFuchkaBanglaSoup(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		tableNoLabel = new JLabel("Table No :");
		...
		JLabel item1Name = new JLabel("Doi Fuchka");
        ...
        JLabel item2Name = new JLabel("Regular Chotpoti");
        ...
        JLabel item3Name = new JLabel("Naga Chotpoti");
        ...
        JLabel item4Name = new JLabel("Egg Chotpoti");
        ...
        JLabel item5Name = new JLabel("Chicken Chotpoti");
        ...
        JLabel item6Name = new JLabel("Pineapple");
        ...
        JLabel item7Name = new JLabel("Orange");
        ...
        JLabel item8Name = new JLabel("Apple");
	...
	public static void main(String []args){
        ...
        new MenuFuchkaBanglaSoup(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			frame.dispose();
			HomePageRestaurantSubway homePageRestaurantSubway = new HomePageRestaurantSubway(homePageDhali);
			homePageRestaurantSubway.setVisible(true);
	 		frame.dispose();
		}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Doi Fuchka         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Regular Chotpoti          "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Naga Chotpoti       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Egg Chotpoti         "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Chotpoti  "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Pineapple       "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Orange          "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Apple          "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
