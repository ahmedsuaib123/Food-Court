...
public class MenuFoodTimesSetMeal extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFoodTimesSetMeal(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
        ...
        JLabel item4Name = new JLabel("Set Menu 4");
        ...
        JLabel item5Name = new JLabel("Set Menu 5");
        ...
        JLabel item6Name = new JLabel("Chicken Rice Bowl");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Set Menu 4     "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Set Menu 5   "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Rice Bowl     "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
