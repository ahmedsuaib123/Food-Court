...
public class MenuSubwayMozito extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSubwayMozito(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
	...
	public static void main(String []args){
        ...
        new MenuSubwayMozito(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
