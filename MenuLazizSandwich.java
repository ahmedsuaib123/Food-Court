...
public class MenuLazizSandwich extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuLazizSandwich(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Beef Kebab Wrap");
        ...
        JLabel item2Name = new JLabel("Tandoori Chicken Wrap");
        ...
        JLabel item3Name = new JLabel("Chicken Pops Wrap");
        ...
        JLabel item4Name = new JLabel("Club Sandwich");
        ...
        JLabel item5Name = new JLabel("Sub Sandwich");
        ...
        JLabel item6Name = new JLabel("Tandoori Chicken Sandwich");
	...
	public static void main(String []args){
        ...
        new MenuLazizSandwich(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Beef Kebab Wrap         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Tandoori Chicken Wrap          "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Pops Wrap       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Club Sandwich         "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Sub Sandwich             "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Tandoori Chicken Sandwich       "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
