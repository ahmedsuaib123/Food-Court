...
public class MenuFoodTimesSnacks extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFoodTimesSnacks(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("BBQ Wings ");
        ...
        JLabel item2Name = new JLabel("Naga Wings");
        ...
        JLabel item3Name = new JLabel("Fish Wonton");
        ...
        JLabel item4Name = new JLabel("French Fries");
        ...
        JLabel item5Name = new JLabel("Hot Wings");
        ...
        JLabel item6Name = new JLabel("Chicken Lolipop");
        ...
        JLabel item7Name = new JLabel("Potato Wedges");
        ...
        JLabel item8Name = new JLabel("Chicken Chowmein");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			frame.dispose();
			HomePageRestaurantFoodTimes homePageRestaurantFoodTimes = new HomePageRestaurantFoodTimes(homePageDhali);
			homePageRestaurantFoodTimes.setVisible(true);
		}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append("   BBQ Wings   "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append("  Naga Wings  "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fish Wonton   "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append("  French Fries  "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Hot Wings  "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Lollipop   "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Potato Wedges          "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Chowmein    "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
