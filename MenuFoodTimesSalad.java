...
public class MenuFoodTimesSalad extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFoodTimesSalad(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Raita ");
        ...
        JLabel item2Name = new JLabel("Seasonal Salad");
        ...
        JLabel item3Name = new JLabel("Sea Food Mixed Salad");
        item3Name.setBounds(450, 140, 100, 25);
   

        JLabel item3Price = new JLabel("Price: "+object.z+" TK");
        item3Price.setBounds(450, 165, 300, 25);
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Raita     "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Seasonal Salad    "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Sea Food Mixed Salad     "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
