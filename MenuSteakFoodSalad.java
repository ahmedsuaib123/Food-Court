...
public class MenuSteakFoodSalad extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSteakFoodSalad(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Cashewnut Salad ");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Cashewnut Salad      "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
