...
public class MenuSpicyVarities extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSpicyVarities(HomePageDhali homePageDhali){
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Mogoj Fry");
        ...
        JLabel item3Name = new JLabel("Chicken Chap");
        ...
        JLabel item4Name = new JLabel("Chicken Boti Kebab");
        ...
        JLabel item5Name = new JLabel("Beef Boti Kebab");
        ...
        JLabel item6Name = new JLabel("Beef Roll");
        ...
        JLabel item7Name = new JLabel("Chicken Roll");
        ...
        JLabel item8Name = new JLabel("Luchi");
	...
	public static void main(String []args){
        ...
        new MenuSpicyVarities(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==button3)//bill
		{
			...
			{
				bill.setText("*** Dhaka Spicy Varities Kabab & Soup ***\n\n Item       Quantity     Price\n");
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Mogoj Fry         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Chap       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Beef Boti Kebab         "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Beef Chap             "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Beef Roll      "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Roll          "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Luchi          "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
