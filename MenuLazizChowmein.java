...
public class MenuLazizChowmein extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuLazizChowmein(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Sizzling Chowmein With Sausage");
        ...
        JLabel item2Name = new JLabel("Egg Chowmein");
        ...
        JLabel item3Name = new JLabel("Chicken Chowmein");
        ...
        JLabel item4Name = new JLabel("American Chopsuey");
	...
	public static void main(String []args){
        ...
        new MenuLazizChowmein(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Sizzling Chowmein With Sausage         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Egg Chowmein          "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Chowmein       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" American Chopsuey         "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
