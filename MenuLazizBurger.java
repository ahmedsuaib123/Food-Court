...
public class MenuLazizBurger extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuLazizBurger(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Chicken Burger");
        ...
        JLabel item2Name = new JLabel("Naga Chicken Burger");
        ...
        JLabel item3Name = new JLabel("Beef Cheese Burger");
        ...
        JLabel item4Name = new JLabel("Beef Steak Burger");
        ...
        JLabel item5Name = new JLabel("Naga Beef Burger");
        ...
        JLabel item6Name = new JLabel("Beef Burger");
        ...
        JLabel item7Name = new JLabel("Special Chicken Cheese Burger");
        ...
        JLabel item8Name = new JLabel("Special Chicken Cheese Burger");
	...
	public static void main(String []args){
        ...
        new MenuLazizBurger(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			frame.dispose();
			HomePageRestaurantLaziz homePageRestaurantLaziz = new HomePageRestaurantLaziz(homePageDhali);
			homePageRestaurantLaziz.setVisible(true);
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Burger         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Naga Chicken Burger          "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Beef Cheese Burger       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Beef Steak Burger         "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Naga Beef Burger             "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Plater C       "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Beef Burger          "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Special Chicken Cheese Burger          "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
