...
public class MenuFuchkaBanglaSnacks extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFuchkaBanglaSnacks(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Crispy Fried Chicken");
        ...
        JLabel item2Name = new JLabel("Thai Fried Chicken");
        ...
        JLabel item3Name = new JLabel("Chicken Cheese Nachos");
        ...
        JLabel item4Name = new JLabel("Beef Cheese Nachos");
        ...
        JLabel item5Name = new JLabel("French Fries");
        ...
        JLabel item6Name = new JLabel("Potato Wedges");
        ...
        JLabel item7Name = new JLabel("Crispy Drumstick");
        ...
        JLabel item8Name = new JLabel("Garlic Mushroom");
	...
	public static void main(String []args){
        ...
        new MenuFuchkaBanglaSoup(homePageDhali); 
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			HomePageRestaurantFuchkaBangla homePageRestaurantFuchkaBangla = new HomePageRestaurantFuchkaBangla(homePageDhali);
			homePageRestaurantFuchkaBangla.setVisible(true);
	 		frame.dispose();
		}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Cheese Nachos   "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Beef Cheese Nachos    "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" French Fries  "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Potato Wedges   "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Crispy Drumstick    "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Garlic Mushroom   "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
