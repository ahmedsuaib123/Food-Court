...
public class MenuTheKitchenMeatBox extends JFrame implements ActionListener{
	JFrame frame ;
	...
	JTextField item5Quantity,tableNo;
	JLabel label;
	Aso object;
    ...
    public MenuTheKitchenMeatBox(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
        ...
        JLabel item2Name = new JLabel("BBQ Chicken");
        ...
        item5Image.setBounds(50, 240, 100, 100);
   

        JLabel item5Name = new JLabel("Steak & Chips");
        item5Name.setBounds(50, 240, 300, 25);
    

        JLabel item5Price = new JLabel("Price: "+object.s+" TK");
        item5Price.setBounds(50, 265, 100, 25);
  												
		
		JLabel item5QuantityLabel = new JLabel("Quantity:");
        item5QuantityLabel.setBounds(50, 290, 100, 25);
   

        item5Quantity = new JTextField();
        item5Quantity.setBounds(110, 290, 30, 25);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(item1Quantity.getText().equals("") && item2Quantity.getText().equals("") && item3Quantity.getText().equals("") && item4Quantity.getText().equals("") && item5Quantity.getText().equals(""))
			{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Overloaded  "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" BBQ Chicken "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Pan Fried Chicken       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Spice & Honey Mustard    "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
					catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					if(Integer.parseInt(item4Quantity.getText())>0 && Integer.parseInt(item4Quantity.getText())<10)
					{
					totalBill+=Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.s);
		
					bill.append(" Steak & Chips   "+item5Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
					catch(NumberFormatException ex)
				{
