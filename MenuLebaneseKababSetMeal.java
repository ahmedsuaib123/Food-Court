...
public class MenuLebaneseKababSetMeal extends JFrame implements ActionListener{
	JFrame frame ;
	
	HomePageDhali homePageDhali;
	HomePageRestaurantLebaneseKabab HomePageRestaurantLebaneseKabab;
    ...
    public MenuLebaneseKababSetMeal(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Fried Rice with Fried Chicken & Vegetable");
        ...
        JLabel item3Name = new JLabel("Blueberry Bunch");
        ...
        JLabel item4Name = new JLabel("Chocolate Blust");
        ...
        JLabel item5Name = new JLabel("Fried Rice with BBQ Chicken & Vegetable");
        item5Name.setBounds(50, 360, 300, 25);
        ...
        JLabel item6Name = new JLabel("Naughty Caramel");
        item6Name.setBounds(250, 360, 300, 25);
        ...
        JLabel item7Name = new JLabel("Butter Scotch Delight");
        item7Name.setBounds(450, 360, 300, 25);
        ...
        JLabel item8Name = new JLabel("Chocolate with Ice-cream");
        item8Name.setBounds(650, 360, 300, 25);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			frame.dispose();
			HomePageRestaurantLebaneseKabab homePageRestaurantLebaneseKabab = new HomePageRestaurantLebaneseKabab(homePageDhali);
			homePageRestaurantLebaneseKabab.setVisible(true);
		}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fried Rice with Fried Chicken & Vegetable "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fried Rice with BBQ Chicken & Vegetable "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Blueberry Bunch       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chocolate Blust    "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Tiramisu Rich  "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fried Rice with BBQ Chicken & Vegetable  "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Butter Scotch Delight  "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chocolate with Ice-cream  "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
