...
public class MenuFoodTimesRotiParatha extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFoodTimesRotiParatha(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Plain Luchi ");
        ...
        JLabel item2Name = new JLabel("Fish Kebab");
        ...
        JLabel item3Name = new JLabel("Fish Fingers");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Plain Luchi       "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
