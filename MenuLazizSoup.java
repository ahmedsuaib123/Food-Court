...
public class MenuLazizSoup extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuLazizSoup(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Vegetable Soup         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
