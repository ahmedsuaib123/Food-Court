...
public class MenuWaffleNut extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuWaffleNut(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Cream Cheese On Red Velvet");
