...
public class MenuFoodTimesBurger extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFoodTimesBurger(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Beef Cheese Burger ");
        ...
        JLabel item2Name = new JLabel("Crispy Chicken Burger");
        ...
        JLabel item3Name = new JLabel("Chicken Cheese Burger");
        ...
        JLabel item4Name = new JLabel("Chicken & Beef Combo Burger");
        ...
        JLabel item5Name = new JLabel("Special Fish Burger");
        ...
        JLabel item6Name = new JLabel("Chicken Sub Burger");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Loitta Fry         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fish Kebab     "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fish Fingers       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
