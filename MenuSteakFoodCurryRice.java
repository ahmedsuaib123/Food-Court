...
public class MenuSteakFoodCurryRice extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSteakFoodCurryRice(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Chicken Sizzling");
        ...
        JLabel item2Name = new JLabel("Special Chicken Sizzling Rice");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Sizzling    "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append("  Special Chicken Sizzling Rice  "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
