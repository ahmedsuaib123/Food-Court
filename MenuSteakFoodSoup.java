...
public class MenuSteakFoodSoup extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSteakFoodSoup(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Chicken Corn Soup");
        ...
        JLabel item2Name = new JLabel("Chicken Thai Soup");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Corn Soup     "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Thai Soup   "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
