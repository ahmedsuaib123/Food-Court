...
public class MenuSubwayLassi extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSubwayLassi(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
	...
	public static void main(String []args){
        ...
        new MenuSubwayLassi(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
