...
public class MenuChayerMela extends JFrame implements ActionListener{
	JFrame frame ;
	...
	JTextField item7Quantity,tableNo;
	JLabel label;
	Aso object;
    ...
    public MenuChayerMela(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
        ...
        JLabel item2Name = new JLabel("Malai Cha");
        ...
        JLabel item3Name = new JLabel(" Iced tea ");
        ...
        JLabel item4Name = new JLabel("Oreo Shake");
        ...
        item4Quantity.setBounds(710, 190, 30, 25);
		 ...
		 // Item 5: ColdCoffee
        JLabel item5Image = new JLabel(new ImageIcon("images/Coffee2.png"));
        item5Image.setBounds(50, 260, 100, 100);
   

        JLabel item5Name = new JLabel("Cold Coffee");
        item5Name.setBounds(50, 260, 300, 25);
    

        JLabel item5Price = new JLabel("Price: "+object.a+" TK");
        item5Price.setBounds(50, 285, 100, 25);
  												
		
		JLabel item5QuantityLabel = new JLabel("Quantity:");
        item5QuantityLabel.setBounds(50, 310, 100, 25);
   

        item5Quantity = new JTextField();
        item5Quantity.setBounds(110, 310, 30, 25);

		
		 // Item 6: Faluda
        JLabel item6Image = new JLabel(new ImageIcon("images/Coffee2.png"));
        item6Image.setBounds(250, 30, 100, 100);
   

        JLabel item6Name = new JLabel("Faluda");
        item6Name.setBounds(250, 260, 300, 25);
    

        JLabel item6Price = new JLabel("Price: "+object.b+" TK");
        item6Price.setBounds(250, 285, 100, 25);
  											
		
		JLabel item6QuantityLabel = new JLabel("Quantity:");
        item6QuantityLabel.setBounds(250, 310, 100, 25);
   

        item6Quantity = new JTextField();
        item6Quantity.setBounds(310, 310, 30, 25);


		 // Item 7: SpecialSmotthie
        JLabel item7Image = new JLabel(new ImageIcon("images/Coffee2.png"));
        item7Image.setBounds(450, 310, 100, 100);
   

        JLabel item7Name = new JLabel("Special Smotthie");
        item7Name.setBounds(450, 260, 300, 25);
    

        JLabel item7Price = new JLabel("Price: "+object.c+" TK");
        item7Price.setBounds(450, 285, 100, 25);
  												
		
		JLabel item7QuantityLabel = new JLabel("Quantity:");
        item7QuantityLabel.setBounds(450, 310, 100, 25);
   

        item7Quantity = new JTextField();
        item7Quantity.setBounds(510, 310, 30, 25);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(item1Quantity.getText().equals("") && item2Quantity.getText().equals("") && item3Quantity.getText().equals("") && item4Quantity.getText().equals("")&& item5Quantity.getText().equals("")&& item6Quantity.getText().equals("")&& item7Quantity.getText().equals(""))
			{
				JOptionPane.showMessageDialog(null, "You Have not select any item.");
			}
			else
			{
				bill.setText("****** Chayer Mela ******\n\n Item       Quantity     Price\n");
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Regular Milk Tea "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Malai Cha "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Iced Tea     "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Oreo Shake   "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
					catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Cold Coffee  "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
					catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Faluda  "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
					catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append("  Special Smotthie   "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
					catch(NumberFormatException ex)
				{
