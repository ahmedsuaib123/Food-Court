...
public class MenuSubwayMilkShake extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSubwayMilkShake(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Strawberry");
	...
	public static void main(String []args){
        ...
        new MenuSubwayMilkShake(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Strawberry         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
