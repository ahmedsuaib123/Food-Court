...
public class MenuLazizSnacks extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuLazizSnacks(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Fried Wonton");
        ...
        JLabel item2Name = new JLabel("Fried Apple");
        ...
        JLabel item3Name = new JLabel("Spicy Sweet Corn");
        ...
        JLabel item4Name = new JLabel("Cheese Fries");
        ...
        JLabel item5Name = new JLabel("Fried Mushroom");
        ...
        JLabel item6Name = new JLabel("Garlic Mushroom");
        ...
        JLabel item7Name = new JLabel("French Fries");
        ...
        JLabel item8Name = new JLabel("Potato Wedges");
	...
	public static void main(String []args){
        ...
        new MenuLazizSnacks(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			frame.dispose();
			HomePageRestaurantLaziz homePageRestaurantIndianDosa = new HomePageRestaurantLaziz(homePageDhali);
			homePageRestaurantIndianDosa.setVisible(true);
	 		frame.dispose();
		}
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fried Wonton         "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fried Apple          "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Spicy Sweet Corn       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Cheese Fries         "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Fried Mushroom             "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Garlic Mushroom       "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" French Fries          "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Potato Wedges          "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
