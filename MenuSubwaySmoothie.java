...
public class MenuSubwaySmoothie extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSubwaySmoothie(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
	...
	public static void main(String []args){
        ...
        new MenuSubwaySmoothie(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
