...
public class MenuSteakFoodRiceBowl extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuSteakFoodRiceBowl(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Mexican Chicken Rice Bowl");
        ...
        JLabel item2Name = new JLabel("Steak Chicken Rice Bowl");
        ...
        JLabel item3Name = new JLabel("BBQ Chicken Curry Rice Bowl");
        ...
        JLabel item4Name = new JLabel("Chicken Chili Rice Bowl");
        ...
        JLabel item5Name = new JLabel("Crispy Chicken Rice Bowl");
        ...
        JLabel item6Name = new JLabel("Chicken Meatball Rice Bowl");
        ...
        JLabel item7Name = new JLabel("Spicy Chicken Rice Bowl");
        ...
        JLabel item8Name = new JLabel("Drumstick Rice Bowl");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Mexican Chicken Rice Bowl   "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Steak Chicken Rice Bowl "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" BBQ Chicken Curry Rice Bowl   "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Chicken Chili Rice Bowl    "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Crispy Chicken Rice Bowl  "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append("  Chicken Meatball Rice Bowl "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item7Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Spicy Chicken Rice Bowl     "+item7Quantity.getText()+"        "+Integer.parseInt(item7Quantity.getText())*Integer.parseInt(object.c)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item8Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Drumstick Rice Bowl    "+item8Quantity.getText()+"        "+Integer.parseInt(item8Quantity.getText())*Integer.parseInt(object.d)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
