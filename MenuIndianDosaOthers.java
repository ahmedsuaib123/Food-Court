...
public class MenuIndianDosaOthers extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuIndianDosaOthers(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Luchi");
        ...
        JLabel item2Name = new JLabel("BBQ Chicken Rice Bowl");
        ...
        JLabel item3Name = new JLabel("BBQ Chicken Wings Rice Bowl");
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" BBQ Chicken Rice Bowl       "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" BBQ Chicken Wings Rice Bowl         "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
