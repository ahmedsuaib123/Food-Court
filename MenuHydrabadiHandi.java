...
public class MenuHydrabadiHandi extends JFrame implements ActionListener{
	JFrame frame ;
	...
	JTextField item6Quantity,tableNo;
    ...
    public MenuHydrabadiHandi(HomePageDhali homePageDhali){
		frame=new JFrame();
        ...
        JLabel item2Name = new JLabel("Handi Meat");
        ...
        JLabel item3Name = new JLabel("Jeera Rice");
        ...
        JLabel item4Name = new JLabel("Dhaba Daal");
        ...
        JLabel item5Name = new JLabel("Jeera Aloo");
        ...
        JLabel item6Name = new JLabel("Paneer Butter Masala");
		...
		frame.setTitle("Hydrabadi Handi");
	...
	public static void main(String []args){
        ...
        new MenuHydrabadiHandi(homePageDhali); // Pass it to the constructor of MenuIndianDosaSetMenu
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			frame.dispose();
			HomePageRestaurantHydrabadiHandi homePageRestaurantHydrabadiHandi = new HomePageRestaurantHydrabadiHandi(homePageDhali);
			homePageRestaurantHydrabadiHandi.setVisible(true);
		...
		if(e.getSource()==button3)//bill
		{
			...
			if(item1Quantity.getText().equals("") && item2Quantity.getText().equals("") && item3Quantity.getText().equals("") && item4Quantity.getText().equals("") && item5Quantity.getText().equals("") && item6Quantity.getText().equals(""))
				JOptionPane.showMessageDialog(null, "You Have not select any item.");
			}
			else
			{
				bill.setText("*********** Hydrabadi Handi  ***********\n\n Item       Quantity     Price\n");
			...
			if(!item1Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Butter Chicken        "+item1Quantity.getText()+"        "+Integer.parseInt(item1Quantity.getText())*Integer.parseInt(object.x)+"\n");
					}
				}
			...
			if(!item2Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Handi Meat         "+item2Quantity.getText()+"        "+Integer.parseInt(item2Quantity.getText())*Integer.parseInt(object.y)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item3Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Jeera Rice      "+item3Quantity.getText()+"        "+Integer.parseInt(item3Quantity.getText())*Integer.parseInt(object.z)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item4Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Dhaba Daal        "+item4Quantity.getText()+"        "+Integer.parseInt(item4Quantity.getText())*Integer.parseInt(object.s)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item5Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Jeera Aloo            "+item5Quantity.getText()+"        "+Integer.parseInt(item5Quantity.getText())*Integer.parseInt(object.a)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
			...
			if(!item6Quantity.getText().equals(""))
			{
				try
				{
					...
					bill.append(" Paneer Butter Masala     "+item6Quantity.getText()+"        "+Integer.parseInt(item6Quantity.getText())*Integer.parseInt(object.b)+"\n");
					}
				}
				catch(NumberFormatException ex)
				{
