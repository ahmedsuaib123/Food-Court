...
public class MenuFoodTimesSeafood extends JFrame implements ActionListener{
	JFrame frame ;
    ...
    public MenuFoodTimesSeafood(HomePageDhali homePageDhali) 
	{
		frame=new JFrame();
		...
		JLabel item1Name = new JLabel("Loitta Fry ");
